...
function theme_options_add_page() {
	add_theme_page( __( 'SimFRA skins', 'sampletheme' ), __( 'SimFRA skins', 'sampletheme' ), 'edit_theme_options', 'theme_options', 'theme_options_do_page' );
}
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Name', 'sampletheme' ); ?></th>
                    <td>
                        <input id="sample_theme_options[name]" class="regular-text" type="text" name="sample_theme_options[name]" value="<?php esc_attr_e( $options['name'] ); ?>" />
                    </td>
                </tr>

                <tr valign="top"><th scope="row"><?php _e( 'Telephone', 'sampletheme' ); ?></th>
					<td>
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Choose skins', 'sampletheme' ); ?></th>
					<td>
